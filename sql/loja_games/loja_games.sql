...
-- -----------------------------------------------------
-- Table `db_loja_games`.`tb_ususarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_ususarios` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  `tb_ususarios_id` BIGINT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tb_produtos_tb_categorias_idx` (`tb_categorias_id` ASC) VISIBLE,
  INDEX `fk_tb_produtos_tb_ususarios1_idx` (`tb_ususarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_produtos_tb_categorias`
    FOREIGN KEY (`tb_categorias_id`)
    REFERENCES `db_loja_games`.`tb_categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_produtos_tb_ususarios1`
    FOREIGN KEY (`tb_ususarios_id`)
    REFERENCES `db_loja_games`.`tb_ususarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
